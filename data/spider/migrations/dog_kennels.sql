...
-- Source: /home/developer/source/querydawg/data/spider/database/dog_kennels/dog_kennels.sqlite

-- Create schema
CREATE SCHEMA IF NOT EXISTS dog_kennels;

-- Table: Breeds
CREATE TABLE dog_kennels.Breeds (
    breed_code VARCHAR(10),
    breed_name VARCHAR(10),
...
CREATE TABLE dog_kennels.Treatment_Types (
    ...
    treatment_type_description VARCHAR(24),
...
CREATE TABLE dog_kennels.Professionals (
    ...
    email_address VARCHAR(37),
    home_phone VARCHAR(24),
    cell_number VARCHAR(22),
...
INSERT INTO dog_kennels.Dogs (dog_id, owner_id, abandoned_yn, breed_code, size_code, name, age, date_of_birth, gender, weight, date_arrived, date_adopted, date_departed) VALUES
    ...
    (12, 12, '0', 'HUS', 'MED', 'Holden', '8', '2009-04-12 06:02:48', '0', '6.92', '2017-10-24 04:45:13', '2018-03-05 06:05:23', '2018-03-25 14:15:41'),
...
North Dock, LA 65357-7228', 'East Ila', 'Connecticut', '41215', 'Frami', 'cole.margarita@example.org', '971.048.3763x9404', '1-185-137-1945x409'),
    (15, 'Employee', 'Lesly', '63949 Keeling Landing Apt. 502
