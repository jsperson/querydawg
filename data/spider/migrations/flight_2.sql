...
-- Data migration
-- airlines: 12 rows
INSERT INTO flight_2.airlines (uid, Airline, Abbreviation, Country) VALUES
...
-- airports: 100 rows
INSERT INTO flight_2.airports (City, AirportCode, AirportName, Country, CountryAbbrev) VALUES
...
-- flights: 1200 rows
INSERT INTO flight_2.flights (Airline, FlightNo, SourceAirport, DestAirport) VALUES
    (1, 28, ' APG', ' ASY'),
    (1, 29, ' ASY', ' APG'),
    (1, 44, ' CVO', ' ACV'),
    (1, 45, ' ACV', ' CVO'),
...
ALTER TABLE flight_2.flights
    ADD CONSTRAINT fk_flights_airports_0
    FOREIGN KEY (DestAirport)
    REFERENCES flight_2.airports (AirportCode);
ALTER TABLE flight_2.flights
    ADD CONSTRAINT fk_flights_airports_1
