...
-- Source: /home/developer/source/querydawg/data/spider/database/world_1/world_1.sqlite

-- Create schema
CREATE SCHEMA IF NOT EXISTS world_1;
...
CREATE TABLE world_1.country (
    ...
    IndepYear BIGINT DEFAULT NULL,
    Population BIGINT NOT NULL DEFAULT '0',
    LifeExpectancy NUMERIC(3,1) DEFAULT NULL,
    GNP NUMERIC(10,2) DEFAULT NULL,
    GNPOld NUMERIC(10,2) DEFAULT NULL,
    LocalName VARCHAR(52) NOT NULL DEFAULT '',
    GovernmentForm VARCHAR(52) NOT NULL DEFAULT '',
    HeadOfState VARCHAR(39) DEFAULT NULL,
...
-- Data migration
-- city: 4079 rows
INSERT INTO world_1.city (ID, Name, CountryCode, District, Population) VALUES
...
-- country: 239 rows
INSERT INTO world_1.country (Code, Name, Continent, Region, SurfaceArea, IndepYear, Population, LifeExpectancy, GNP, GNPOld, LocalName, GovernmentForm, HeadOfState, Capital, Code2) VALUES
    ...
    ('ATA', 'Antarctica', 'Antarctica', 'Antarctica', 13120000.0, NULL, 0, NULL, 0.0, NULL, '–', 'Co-administrated', '', NULL, 'AQ'),
    ('ATF', 'French Southern territories', 'Antarctica', 'Antarctica', 7780.0, NULL, 0, NULL, 0.0, NULL, 'Terres australes françaises', 'Nonmetropolitan Territory of France', 'Jacques Chirac', NULL, 'TF'),
    ...
    ('BEL', 'Belgium', 'Europe', 'Western Europe', 30518.0, 1830, 10239000, 77.8, 249704.0, 243948.0, 'België/Belgique', 'Constitutional Monarchy, Federation', 'Albert II', 179, 'BE'),
    ...
    ('BGR', 'Bulgaria', 'Europe', 'Eastern Europe', 110994.0, 1908, 8190900, 70.9, 12178.0, 10169.0, 'Balgarija', 'Republic', 'Petar Stojanov', 539, 'BG'),
    ...
    ('BIH', 'Bosnia and Herzegovina', 'Europe', 'Southern Europe', 51197.0, 1992, 3972000, 71.5, 2841.0, NULL, 'Bosna i Hercegovina', 'Federal Republic', 'Ante Jelavic', 201, 'BA'),
    ('BLR', 'Belarus', 'Europe', 'Eastern Europe', 207600.0, 1991, 10236000, 68.0, 13714.0, NULL, 'Belarus', 'Republic', 'Aljaksandr Lukašenka', 3520, 'BY'),
    ...
    ('BMU', 'Bermuda', 'North America', 'North America', 53.0, NULL, 65000, 76.9, 2328.0, 2190.0, 'Bermuda', 'Dependent Territory of the UK', 'Elisabeth II', 191, 'BM'),
    ('BOL', 'Bolivia', 'South America', 'South America', 1098581.0, 1825, 8329000, 63.7, 8571.0, 7967.0, 'Bolivia', 'Republic', 'Hugo Bánzer Suárez', 194, 'BO'),
    ...
    ('BVT', 'Bouvet Island', 'Antarctica', 'Antarctica', 59.0, NULL, 0, NULL, 0.0, NULL, 'Bouvetøya', 'Dependent Territory of Norway', 'Harald V', NULL, 'BV'),
    ('BWA', 'Botswana', 'Africa', 'Southern Africa', 581730.0, 1966, 1622000, 39.3, 4834.0, 4935.0, 'Botswana', 'Republic', 'Festus G. Mogae', 204, 'BW'),
    ('CAF', 'Central African Republic', 'Africa', 'Central Africa', 622984.0, 1960, 3615000, 44.0, 1054.0, 993.0, 'Centrafrique/Bê-Afrîka', 'Republic', 'Ange-Félix Patassé', 1889, 'CF'),
    ...
    ('CCK', 'Cocos (Keeling) Islands', 'Oceania', 'Australia and New Zealand', 14.0, NULL, 600, NULL, 0.0, NULL, 'Cocos (Keeling) Islands', 'Territory of Australia', 'Elisabeth II', 2317, 'CC'),
    ...
    ('ESH', 'Western Sahara', 'Africa', 'Northern Africa', 266000.0, NULL, 293000, 49.8, 60.0, NULL, 'As-Sahrawiya', 'Occupied by Marocco', 'Mohammed Abdel Aziz', 2453, 'EH'),
    ...
    ('FLK', 'Falkland Islands', 'South America', 'South America', 12173.0, NULL, 2000, NULL, 0.0, NULL, 'Falkland Islands', 'Dependent Territory of the UK', 'Elisabeth II', 763, 'FK'),
    ('FRA', 'France', 'Europe', 'Western Europe', 551500.0, 843, 59225700, 78.8, 1424285.0, 1392448.0, 'France', 'Republic', 'Jacques Chirac', 2974, 'FR'),
    ('FRO', 'Faroe Islands', 'Europe', 'Nordic Countries', 1399.0, NULL, 43000, 78.4, 0.0, NULL, 'Føroyar', 'Part of Denmark', 'Margrethe II', 901, 'FO'),
    ...
    ('GRD', 'Grenada', 'North America', 'Caribbean', 344.0, 1974, 94000, 64.5, 318.0, NULL, 'Grenada', 'Constitutional Monarchy', 'Elisabeth II', 916, 'GD'),
    ('GRL', 'Greenland', 'North America', 'North America', 2166090.0, NULL, 56000, 68.1, 0.0, NULL, 'Kalaallit Nunaat/Grønland', 'Part of Denmark', 'Margrethe II', 917, 'GL'),
    ...
    ('GUF', 'French Guiana', 'South America', 'South America', 90000.0, NULL, 181000, 76.1, 681.0, NULL, 'Guyane française', 'Overseas Department of France', 'Jacques Chirac', 3014, 'GF'),
    ('GUM', 'Guam', 'Oceania', 'Micronesia', 549.0, NULL, 168000, 77.8, 1197.0, 1136.0, 'Guam', 'US Territory', 'George W. Bush', 921, 'GU'),
    ('GUY', 'Guyana', 'South America', 'South America', 214969.0, 1966, 861000, 64.0, 722.0, 743.0, 'Guyana', 'Republic', 'Bharrat Jagdeo', 928, 'GY'),
    ('HKG', 'Hong Kong', 'Asia', 'Eastern Asia', 1075.0, NULL, 6782000, 79.5, 166448.0, 173610.0, 'Xianggang/Hong Kong', 'Special Administrative Region of China', 'Jiang Zemin', 937, 'HK'),
    ('HMD', 'Heard Island and McDonald Islands', 'Antarctica', 'Antarctica', 359.0, NULL, 0, NULL, 0.0, NULL, 'Heard and McDonald Islands', 'Territory of Australia', 'Elisabeth II', NULL, 'HM'),
...
INSERT INTO world_1.country (Code, Name, Continent, Region, SurfaceArea, IndepYear, Population, LifeExpectancy, GNP, GNPOld, LocalName, GovernmentForm, HeadOfState, Capital, Code2) VALUES
    ('IOT', 'British Indian Ocean Territory', 'Africa', 'Eastern Africa', 78.0, NULL, 0, NULL, 0.0, NULL, 'British Indian Ocean Territory', 'Dependent Territory of the UK', 'Elisabeth II', NULL, 'IO'),
    ...
    ('IRQ', 'Iraq', 'Asia', 'Middle East', 438317.0, 1932, 23115000, 66.5, 11500.0, NULL, 'Al-´Iraq', 'Republic', 'Saddam Hussein al-Takriti', 1365, 'IQ'),
    ...
    ('LBR', 'Liberia', 'Africa', 'Western Africa', 111369.0, 1847, 3154000, 51.0, 2012.0, NULL, 'Liberia', 'Republic', 'Charles Taylor', 2440, 'LR'),
    ...
    ('LCA', 'Saint Lucia', 'North America', 'Caribbean', 622.0, 1979, 154000, 72.3, 571.0, NULL, 'Saint Lucia', 'Constitutional Monarchy', 'Elisabeth II', 3065, 'LC'),
    ...
    ('MDV', 'Maldives', 'Asia', 'Southern and Central Asia', 298.0, 1965, 286000, 62.2, 199.0, NULL, 'Dhivehi Raajje/Maldives', 'Republic', 'Maumoon Abdul Gayoom', 2463, 'MV'),
    ...
    ('MHL', 'Marshall Islands', 'Oceania', 'Micronesia', 181.0, 1990, 64000, 65.5, 97.0, NULL, 'Marshall Islands/Majol', 'Republic', 'Kessai Note', 2507, 'MH'),
    ...
    ('MNP', 'Northern Mariana Islands', 'Oceania', 'Micronesia', 464.0, NULL, 78000, 75.5, 0.0, NULL, 'Northern Mariana Islands', 'Commonwealth of the US', 'George W. Bush', 2913, 'MP'),
    ...
    ('MSR', 'Montserrat', 'North America', 'Caribbean', 102.0, NULL, 11000, 78.0, 109.0, NULL, 'Montserrat', 'Dependent Territory of the UK', 'Elisabeth II', 2697, 'MS'),
    ('MTQ', 'Martinique', 'North America', 'Caribbean', 1102.0, NULL, 395000, 78.3, 2731.0, 2559.0, 'Martinique', 'Overseas Department of France', 'Jacques Chirac', 2508, 'MQ'),
    ('MUS', 'Mauritius', 'Africa', 'Eastern Africa', 2040.0, 1968, 1158000, 71.0, 4251.0, 4186.0, 'Mauritius', 'Republic', 'Cassam Uteem', 2511, 'MU'),
    ...
    ('MYT', 'Mayotte', 'Africa', 'Eastern Africa', 373.0, NULL, 149000, 59.5, 0.0, NULL, 'Mayotte', 'Territorial Collectivity of France', 'Jacques Chirac', 2514, 'YT'),
    ('NAM', 'Namibia', 'Africa', 'Southern Africa', 824292.0, 1990, 1726000, 42.5, 3101.0, 3384.0, 'Namibia', 'Republic', 'Sam Nujoma', 2726, 'NA'),
    ('NCL', 'New Caledonia', 'Oceania', 'Melanesia', 18575.0, NULL, 214000, 72.8, 3563.0, NULL, 'Nouvelle-Calédonie', 'Nonmetropolitan Territory of France', 'Jacques Chirac', 3493, 'NC'),
    ('NER', 'Niger', 'Africa', 'Western Africa', 1267000.0, 1960, 10730000, 41.3, 1706.0, 1580.0, 'Niger', 'Republic', 'Mamadou Tandja', 2738, 'NE'),
    ('NFK', 'Norfolk Island', 'Oceania', 'Australia and New Zealand', 36.0, NULL, 2000, NULL, 0.0, NULL, 'Norfolk Island', 'Territory of Australia', 'Elisabeth II', 2806, 'NF'),
    ...
    ('NIU', 'Niue', 'Oceania', 'Polynesia', 260.0, NULL, 2000, NULL, 0.0, NULL, 'Niue', 'Nonmetropolitan Territory of New Zealand', 'Elisabeth II', 2805, 'NU'),
    ...
    ('PCN', 'Pitcairn', 'Oceania', 'Polynesia', 49.0, NULL, 50, NULL, 0.0, NULL, 'Pitcairn', 'Dependent Territory of the UK', 'Elisabeth II', 2912, 'PN'),
    ...
    ('PSE', 'Palestine', 'Asia', 'Middle East', 6257.0, NULL, 3101000, 71.4, 4173.0, NULL, 'Filastin', 'Autonomous Area', 'Yasser (Yasir) Arafat', 4074, 'PS'),
    ('PYF', 'French Polynesia', 'Oceania', 'Polynesia', 4000.0, NULL, 235000, 74.8, 818.0, 781.0, 'Polynésie française', 'Nonmetropolitan Territory of France', 'Jacques Chirac', 3016, 'PF'),
    ('QAT', 'Qatar', 'Asia', 'Middle East', 11000.0, 1971, 599000, 72.4, 9472.0, 8920.0, 'Qatar', 'Monarchy', 'Hamad ibn Khalifa al-Thani', 2973, 'QA'),
    ('REU', 'Réunion', 'Africa', 'Eastern Africa', 2510.0, NULL, 699000, 72.7, 8287.0, 7988.0, 'Réunion', 'Overseas Department of France', 'Jacques Chirac', 3017, 'RE'),
    ...
    ('SMR', 'San Marino', 'Europe', 'Southern Europe', 61.0, 885, 27000, 81.1, 510.0, NULL, 'San Marino', 'Republic', NULL, 3171, 'SM'),
    ('SOM', 'Somalia', 'Africa', 'Eastern Africa', 637657.0, 1960, 10097000, 46.2, 935.0, NULL, 'Soomaaliya', 'Republic', 'Abdiqassim Salad Hassan', 3214, 'SO'),
    ('SPM', 'Saint Pierre and Miquelon', 'North America', 'North America', 242.0, NULL, 7000, 77.6, 0.0, NULL, 'Saint-Pierre-et-Miquelon', 'Territorial Collectivity of France', 'Jacques Chirac', 3067, 'PM'),
    ('STP', 'Sao Tome and Principe', 'Africa', 'Central Africa', 964.0, 1975, 147000, 65.3, 6.0, NULL, 'São Tomé e Príncipe', 'Republic', 'Miguel Trovoada', 3172, 'ST'),
...
INSERT INTO world_1.country (Code, Name, Continent, Region, SurfaceArea, IndepYear, Population, LifeExpectancy, GNP, GNPOld, LocalName, GovernmentForm, HeadOfState, Capital, Code2) VALUES
    ...
    ('TCA', 'Turks and Caicos Islands', 'North America', 'Caribbean', 430.0, NULL, 17000, 73.3, 96.0, NULL, 'The Turks and Caicos Islands', 'Dependent Territory of the UK', 'Elisabeth II', 3423, 'TC'),
    ...
    ('TUV', 'Tuvalu', 'Oceania', 'Polynesia', 26.0, 1978, 12000, 66.3, 6.0, NULL, 'Tuvalu', 'Constitutional Monarchy', 'Elisabeth II', 3424, 'TV'),
    ...
    ('UMI', 'United States Minor Outlying Islands', 'Oceania', 'Micronesia/Caribbean', 16.0, NULL, 0, NULL, 0.0, NULL, 'United States Minor Outlying Islands', 'Dependent Territory of the US', 'George W. Bush', NULL, 'UM'),
    ...
    ('VAT', 'Holy See (Vatican City State)', 'Europe', 'Southern Europe', 0.4, 1929, 1000, NULL, 9.0, NULL, 'Santa Sede/Città del Vaticano', 'Independent Church State', 'Johannes Paavali II', 3538, 'VA'),
    ('VCT', 'Saint Vincent and the Grenadines', 'North America', 'Caribbean', 388.0, 1979, 114000, 72.3, 285.0, NULL, 'Saint Vincent and the Grenadines', 'Constitutional Monarchy', 'Elisabeth II', 3066, 'VC'),
    ...
    ('VGB', 'Virgin Islands, British', 'North America', 'Caribbean', 151.0, NULL, 21000, 75.4, 612.0, 573.0, 'British Virgin Islands', 'Dependent Territory of the UK', 'Elisabeth II', 537, 'VG'),
    ('VIR', 'Virgin Islands, U.S.', 'North America', 'Caribbean', 347.0, NULL, 93000, 78.1, 0.0, NULL, 'Virgin Islands of the United States', 'US Territory', 'George W. Bush', 4067, 'VI'),
    ...
    ('WLF', 'Wallis and Futuna', 'Oceania', 'Polynesia', 200.0, NULL, 15000, NULL, 0.0, NULL, 'Wallis-et-Futuna', 'Nonmetropolitan Territory of France', 'Jacques Chirac', 3536, 'WF'),
...
-- countrylanguage: 984 rows
INSERT INTO world_1.countrylanguage (CountryCode, Language, IsOfficial, Percentage) VALUES
    ('ABW', 'Dutch', 'T', 5.3),
    ('ABW', 'English', 'F', 9.5),
...
ALTER TABLE world_1.city
    ADD CONSTRAINT fk_city_country_0
    FOREIGN KEY (CountryCode)
    REFERENCES world_1.country (Code);
ALTER TABLE world_1.countrylanguage
    ADD CONSTRAINT fk_countrylanguage_country_0
    FOREIGN KEY (CountryCode)
    REFERENCES world_1.country (Code);
